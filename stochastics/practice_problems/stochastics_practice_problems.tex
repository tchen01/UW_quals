...
\subsubsection{Computing solution to KBE}
\begin{enumerate}[nolistsep]
    \item Write down \( \cA \)
...
\textit{Sample Problems}:
\begin{itemize}[nolistsep]
    \item PROBLEMS FROM PRACTICE EXAM
\end{itemize}
...
\begin{itemize}[nolistsep]
    ...
    \item \hyperref[Exercise 9.2]{Exercise 9.2}: Find PDE for given expression (solution using theorem and by finding martingale)
\end{itemize}
